...
API RESTful para encurtamento de URLs construída com:
*  **NestJS**, 
* **TypeScript**, 
* **PostgreSQL**
* **Docker**.
...
* Possuir [Docker](https://www.docker.com/) instalado

### Opção B — Sem Docker
* Possuir o [Node.js](https://nodejs.org/pt-br/download) instalado
* Possuir um banco de dados instalado, como o [PostgreSQL](https://www.postgresql.org/)
...
#### 3. Copie o arquivo de ambiente usando o comando:
...
#### 5. Acesse a API em http://localhost:3000 e Swagger em http://localhost:3000/docs
...
#### Como parar a execução e remover os containers

Para derrubar os containers criados pelo compose use o comando:
...
- Infra de suporte: Redis (cache, rate-limit), fila (RabbitMQ / SQS), connection pooler (PgBouncer).
